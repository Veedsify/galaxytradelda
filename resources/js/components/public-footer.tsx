...
export default function PublicFooter() {
    ...
    return (
        <footer className="relative w-full overflow-hidden bg-[#1a2171] text-white">
            ...
            <div className="group fixed bottom-6 left-4 z-50 flex items-center gap-2">
                <a
                ...
                <span className="rounded-full bg-white px-3 py-1 text-xs font-semibold text-gray-700 opacity-0 shadow transition-opacity duration-300 group-hover:opacity-100">
                    Contact us
                </span>
            </div>
        </footer>
