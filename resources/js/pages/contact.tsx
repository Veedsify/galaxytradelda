                ...
                <main className="mx-auto w-full max-w-6xl flex-1 px-6 py-14">
                    <div className="grid gap-10 lg:grid-cols-2">
                        ...
                        <div className="flex flex-col gap-6">
                            <div>
                                <h2 className="mb-1 text-2xl font-bold text-[#1a2171]">
                                    Get in Touch
                                </h2>
                                <p className="text-sm leading-relaxed text-gray-500">
                                    Have a question or want to do business with
                                    us? Reach out and our team will get back to
                                    you within 24 hours.
                                </p>
                            </div>
                        ...
                        <div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
                            <h2 className="mb-6 text-2xl font-bold text-[#1a2171]">
                                Send a Message
                            </h2>
                                    ...
                                    <div className="flex flex-col gap-5">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm transition outline-none focus:border-[#1a2171] focus:ring-2 focus:ring-[#1a2171]/20"
                                            />
                                            {errors.name && (
